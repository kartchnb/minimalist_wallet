...
module Cover_Generate()
{
    ...
    module Generate_GrooveCutoutOutlines()
    {
        ...
        capture_height = Cover_Channel_Diameter/2;
        
        capture_x_offset = groove_x_offset;
        capture_y_offset = groove_y_offset - capture_height/2;
        ...
        mirror([x_mirror, 0])
        {
            ...
            translate([capture_x_offset, capture_y_offset])
                square([capture_width, capture_height]);
        }
    }
    ...
    module Generate_WingCutoutOutlines()
    {
        ...
        cutout_height_1 = Cover_Length * Groove_Inset_Factor*2 - Cover_Channel_Diameter - Cover_Thickness*2;
        cutout_height_2 = cutout_height_1 * Wing_Taper_Factor;
        ...
        [
            [0, cutout_height_1/2],
            [-cutout_width, cutout_height_2/2],
            [-cutout_width, -cutout_height_2/2],
            [0, -cutout_height_1/2],
        ];
    ...
    module Generate_AccessCutouts()
    {
        ...
        cutout_height = Cover_Length * Groove_Inset_Factor;
        ...
        [
            [-cutout_width_1/2, 0],
            [cutout_width_1/2, 0,],
            [cutout_width_2/2, -cutout_height],
            [-cutout_width_2/2, -cutout_height],
        ];
