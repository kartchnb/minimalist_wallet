...
module ElasticBand_Generate(wallet_thickness)
{
    ...
    channel_y_offset = Cover_Length/2 - Cover_Channel_Inset + Mate_Spacing;
    bottom_z_offset = 0;
    top_z_offset = bottom_z_offset + wallet_thickness;

    clip_edge_x_offset = MoneyClip_Length/2 + Mate_Spacing;
    clip_top_y_offset = MoneyClip_Width/2 - Pocket_Insert_Wall_Thickness - Mate_Spacing;
    clip_inside_z_offset = -MoneyClip_Thickness/2 + Mate_Spacing + Cover_Thickness;

    points =
    [
        [cover_edge_x_offset + diameter/2, channel_y_offset, bottom_z_offset - diameter/2],
        [clip_edge_x_offset , clip_top_y_offset - diameter/2, clip_inside_z_offset],
        [-clip_edge_x_offset + diameter/2, clip_top_y_offset - diameter/2, clip_inside_z_offset],
        [-cover_edge_x_offset - diameter/2, channel_y_offset, bottom_z_offset - diameter/2],
        [-cover_edge_x_offset - diameter/2, channel_y_offset, top_z_offset + diameter/2],
        [cover_edge_x_offset + diameter/2, channel_y_offset, top_z_offset + diameter/2],
        [cover_edge_x_offset + diameter/2, channel_y_offset, bottom_z_offset - diameter/2],
    ];
